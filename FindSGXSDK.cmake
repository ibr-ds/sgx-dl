...
find_path (SGXSDK_EAUG_INCLUDE_DIRS
        NAMES
        sgx_eaug.h
        PATHS
        /home/weichbr/nsgx1/opt/intel/sgxsdk/include)

if (NOT {SGXSDK_EAUG_INCLUDE_DIRS})
    set(SGXSDK_EAUG_INCLUDE_DIRS "")
endif (NOT {SGXSDK_EAUG_INCLUDE_DIRS})
...
mark_as_advanced(SGXSDK_INCLUDE_DIRS SGXSDK_EAUG_INCLUDE_DIRS SGXSDK_ENCL_C_INCLUDE_DIRS SGXSDK_ENCL_CXX_INCLUDE_DIRS SGXSDK_URTS SGXSDK_URTS_SIM SGXSDK_UAE SGXSDK_UAE_SIM SGXSDK_TRTS SGXSDK_TRST_SIM)
